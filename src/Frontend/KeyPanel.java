...
public class KeyPanel extends JPanel {
    ...
    public static final float[] keyX = {117, 202, 287, 372, 457, 542, 627, 712, 797, 882,
                                        ...
                                        202, 287, 372, 457, 542, 627, 712, 797, 940,
                                        120, 272, 424, 576, 728, 880};
    static final int KEYNUM = 28;
    KeyPanel(Color panelColor){
        ...
        bottom.add(Box.createRigidArea(new Dimension(162, 0)));
        for (int i = 19; i < KEYNUM; i ++){
            bottom.add(keys[i]);
            if(i < 26){
                bottom.add(Box.createRigidArea(rigidBoxDimension));
            }
            if(i == 26){
                bottom.add(Box.createRigidArea(new Dimension(63, 0)));
            }
            if(i == 27){
